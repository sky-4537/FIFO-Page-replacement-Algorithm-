...
var hit = 0;
var hit_rate = document.getElementById('hit-rate');
var miss_rate = document.getElementById("miss-rate");
let page_faults = 0;
var indexes = [];
let s = new Set();
var i = 0;
...
function pageFaults()
{
	...
	hits.innerHTML = hit;
	var x = (hit / (hit + page_faults)) * 100;
	x = x.toFixed(3)
	hit_rate.innerHTML = x + "%";
	var y = (100 - (x));
	miss_rate.innerHTML = y + "%";
}
